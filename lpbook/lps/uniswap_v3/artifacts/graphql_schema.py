...
class Collect_orderBy(sgqlc.types.Enum):
    __schema__ = graphql_schema
    __choices__ = ('amount0', 'amount1', 'amountUSD', 'id', 'logIndex', 'owner', 'pool', 'pool__collectedFeesToken0', 'pool__collectedFeesToken1', 'pool__collectedFeesUSD', 'pool__createdAtBlockNumber', 'pool__createdAtTimestamp', 'pool__feeGrowthGlobal0X128', 'pool__feeGrowthGlobal1X128', 'pool__feeTier', 'pool__feesUSD', 'pool__id', 'pool__liquidity', 'pool__liquidityProviderCount', 'pool__observationIndex', 'pool__sqrtPrice', 'pool__tick', 'pool__token0Price', 'pool__token1Price', 'pool__totalValueLockedETH', 'pool__totalValueLockedToken0', 'pool__totalValueLockedToken1', 'pool__totalValueLockedUSD', 'pool__totalValueLockedUSDUntracked', 'pool__txCount', 'pool__untrackedVolumeUSD', 'pool__volumeToken0', 'pool__volumeToken1', 'pool__volumeUSD', 'tickLower', 'tickUpper', 'timestamp', 'transaction', 'transaction__blockNumber', 'transaction__gasPrice', 'transaction__gasUsed', 'transaction__id', 'transaction__timestamp')
...
class Flash_orderBy(sgqlc.types.Enum):
    __schema__ = graphql_schema
    __choices__ = ('amount0', 'amount0Paid', 'amount1', 'amount1Paid', 'amountUSD', 'id', 'logIndex', 'pool', 'pool__collectedFeesToken0', 'pool__collectedFeesToken1', 'pool__collectedFeesUSD', 'pool__createdAtBlockNumber', 'pool__createdAtTimestamp', 'pool__feeGrowthGlobal0X128', 'pool__feeGrowthGlobal1X128', 'pool__feeTier', 'pool__feesUSD', 'pool__id', 'pool__liquidity', 'pool__liquidityProviderCount', 'pool__observationIndex', 'pool__sqrtPrice', 'pool__tick', 'pool__token0Price', 'pool__token1Price', 'pool__totalValueLockedETH', 'pool__totalValueLockedToken0', 'pool__totalValueLockedToken1', 'pool__totalValueLockedUSD', 'pool__totalValueLockedUSDUntracked', 'pool__txCount', 'pool__untrackedVolumeUSD', 'pool__volumeToken0', 'pool__volumeToken1', 'pool__volumeUSD', 'recipient', 'sender', 'timestamp', 'transaction', 'transaction__blockNumber', 'transaction__gasPrice', 'transaction__gasUsed', 'transaction__id', 'transaction__timestamp')
...
class PoolDayData_orderBy(sgqlc.types.Enum):
    __schema__ = graphql_schema
    __choices__ = ('close', 'date', 'feeGrowthGlobal0X128', 'feeGrowthGlobal1X128', 'feesUSD', 'high', 'id', 'liquidity', 'low', 'open', 'pool', 'pool__collectedFeesToken0', 'pool__collectedFeesToken1', 'pool__collectedFeesUSD', 'pool__createdAtBlockNumber', 'pool__createdAtTimestamp', 'pool__feeGrowthGlobal0X128', 'pool__feeGrowthGlobal1X128', 'pool__feeTier', 'pool__feesUSD', 'pool__id', 'pool__liquidity', 'pool__liquidityProviderCount', 'pool__observationIndex', 'pool__sqrtPrice', 'pool__tick', 'pool__token0Price', 'pool__token1Price', 'pool__totalValueLockedETH', 'pool__totalValueLockedToken0', 'pool__totalValueLockedToken1', 'pool__totalValueLockedUSD', 'pool__totalValueLockedUSDUntracked', 'pool__txCount', 'pool__untrackedVolumeUSD', 'pool__volumeToken0', 'pool__volumeToken1', 'pool__volumeUSD', 'sqrtPrice', 'tick', 'token0Price', 'token1Price', 'tvlUSD', 'txCount', 'volumeToken0', 'volumeToken1', 'volumeUSD')


class PoolHourData_orderBy(sgqlc.types.Enum):
    __schema__ = graphql_schema
    __choices__ = ('close', 'feeGrowthGlobal0X128', 'feeGrowthGlobal1X128', 'feesUSD', 'high', 'id', 'liquidity', 'low', 'open', 'periodStartUnix', 'pool', 'pool__collectedFeesToken0', 'pool__collectedFeesToken1', 'pool__collectedFeesUSD', 'pool__createdAtBlockNumber', 'pool__createdAtTimestamp', 'pool__feeGrowthGlobal0X128', 'pool__feeGrowthGlobal1X128', 'pool__feeTier', 'pool__feesUSD', 'pool__id', 'pool__liquidity', 'pool__liquidityProviderCount', 'pool__observationIndex', 'pool__sqrtPrice', 'pool__tick', 'pool__token0Price', 'pool__token1Price', 'pool__totalValueLockedETH', 'pool__totalValueLockedToken0', 'pool__totalValueLockedToken1', 'pool__totalValueLockedUSD', 'pool__totalValueLockedUSDUntracked', 'pool__txCount', 'pool__untrackedVolumeUSD', 'pool__volumeToken0', 'pool__volumeToken1', 'pool__volumeUSD', 'sqrtPrice', 'tick', 'token0Price', 'token1Price', 'tvlUSD', 'txCount', 'volumeToken0', 'volumeToken1', 'volumeUSD')


class Pool_orderBy(sgqlc.types.Enum):
    __schema__ = graphql_schema
    __choices__ = ('burns', 'collectedFeesToken0', 'collectedFeesToken1', 'collectedFeesUSD', 'collects', 'createdAtBlockNumber', 'createdAtTimestamp', 'feeGrowthGlobal0X128', 'feeGrowthGlobal1X128', 'feeTier', 'feesUSD', 'id', 'liquidity', 'liquidityProviderCount', 'mints', 'observationIndex', 'poolDayData', 'poolHourData', 'sqrtPrice', 'swaps', 'tick', 'ticks', 'token0', 'token0Price', 'token0__decimals', 'token0__derivedETH', 'token0__feesUSD', 'token0__id', 'token0__name', 'token0__poolCount', 'token0__symbol', 'token0__totalSupply', 'token0__totalValueLocked', 'token0__totalValueLockedUSD', 'token0__totalValueLockedUSDUntracked', 'token0__txCount', 'token0__untrackedVolumeUSD', 'token0__volume', 'token0__volumeUSD', 'token1', 'token1Price', 'token1__decimals', 'token1__derivedETH', 'token1__feesUSD', 'token1__id', 'token1__name', 'token1__poolCount', 'token1__symbol', 'token1__totalSupply', 'token1__totalValueLocked', 'token1__totalValueLockedUSD', 'token1__totalValueLockedUSDUntracked', 'token1__txCount', 'token1__untrackedVolumeUSD', 'token1__volume', 'token1__volumeUSD', 'totalValueLockedETH', 'totalValueLockedToken0', 'totalValueLockedToken1', 'totalValueLockedUSD', 'totalValueLockedUSDUntracked', 'txCount', 'untrackedVolumeUSD', 'volumeToken0', 'volumeToken1', 'volumeUSD')


class PositionSnapshot_orderBy(sgqlc.types.Enum):
    __schema__ = graphql_schema
    __choices__ = ('blockNumber', 'collectedFeesToken0', 'collectedFeesToken1', 'depositedToken0', 'depositedToken1', 'feeGrowthInside0LastX128', 'feeGrowthInside1LastX128', 'id', 'liquidity', 'owner', 'pool', 'pool__collectedFeesToken0', 'pool__collectedFeesToken1', 'pool__collectedFeesUSD', 'pool__createdAtBlockNumber', 'pool__createdAtTimestamp', 'pool__feeGrowthGlobal0X128', 'pool__feeGrowthGlobal1X128', 'pool__feeTier', 'pool__feesUSD', 'pool__id', 'pool__liquidity', 'pool__liquidityProviderCount', 'pool__observationIndex', 'pool__sqrtPrice', 'pool__tick', 'pool__token0Price', 'pool__token1Price', 'pool__totalValueLockedETH', 'pool__totalValueLockedToken0', 'pool__totalValueLockedToken1', 'pool__totalValueLockedUSD', 'pool__totalValueLockedUSDUntracked', 'pool__txCount', 'pool__untrackedVolumeUSD', 'pool__volumeToken0', 'pool__volumeToken1', 'pool__volumeUSD', 'position', 'position__collectedFeesToken0', 'position__collectedFeesToken1', 'position__depositedToken0', 'position__depositedToken1', 'position__feeGrowthInside0LastX128', 'position__feeGrowthInside1LastX128', 'position__id', 'position__liquidity', 'position__owner', 'position__withdrawnToken0', 'position__withdrawnToken1', 'timestamp', 'transaction', 'transaction__blockNumber', 'transaction__gasPrice', 'transaction__gasUsed', 'transaction__id', 'transaction__timestamp', 'withdrawnToken0', 'withdrawnToken1')


class Position_orderBy(sgqlc.types.Enum):
    __schema__ = graphql_schema
    __choices__ = ('collectedFeesToken0', 'collectedFeesToken1', 'depositedToken0', 'depositedToken1', 'feeGrowthInside0LastX128', 'feeGrowthInside1LastX128', 'id', 'liquidity', 'owner', 'pool', 'pool__collectedFeesToken0', 'pool__collectedFeesToken1', 'pool__collectedFeesUSD', 'pool__createdAtBlockNumber', 'pool__createdAtTimestamp', 'pool__feeGrowthGlobal0X128', 'pool__feeGrowthGlobal1X128', 'pool__feeTier', 'pool__feesUSD', 'pool__id', 'pool__liquidity', 'pool__liquidityProviderCount', 'pool__observationIndex', 'pool__sqrtPrice', 'pool__tick', 'pool__token0Price', 'pool__token1Price', 'pool__totalValueLockedETH', 'pool__totalValueLockedToken0', 'pool__totalValueLockedToken1', 'pool__totalValueLockedUSD', 'pool__totalValueLockedUSDUntracked', 'pool__txCount', 'pool__untrackedVolumeUSD', 'pool__volumeToken0', 'pool__volumeToken1', 'pool__volumeUSD', 'tickLower', 'tickLower__collectedFeesToken0', 'tickLower__collectedFeesToken1', 'tickLower__collectedFeesUSD', 'tickLower__createdAtBlockNumber', 'tickLower__createdAtTimestamp', 'tickLower__feeGrowthOutside0X128', 'tickLower__feeGrowthOutside1X128', 'tickLower__feesUSD', 'tickLower__id', 'tickLower__liquidityGross', 'tickLower__liquidityNet', 'tickLower__liquidityProviderCount', 'tickLower__poolAddress', 'tickLower__price0', 'tickLower__price1', 'tickLower__tickIdx', 'tickLower__untrackedVolumeUSD', 'tickLower__volumeToken0', 'tickLower__volumeToken1', 'tickLower__volumeUSD', 'tickUpper', 'tickUpper__collectedFeesToken0', 'tickUpper__collectedFeesToken1', 'tickUpper__collectedFeesUSD', 'tickUpper__createdAtBlockNumber', 'tickUpper__createdAtTimestamp', 'tickUpper__feeGrowthOutside0X128', 'tickUpper__feeGrowthOutside1X128', 'tickUpper__feesUSD', 'tickUpper__id', 'tickUpper__liquidityGross', 'tickUpper__liquidityNet', 'tickUpper__liquidityProviderCount', 'tickUpper__poolAddress', 'tickUpper__price0', 'tickUpper__price1', 'tickUpper__tickIdx', 'tickUpper__untrackedVolumeUSD', 'tickUpper__volumeToken0', 'tickUpper__volumeToken1', 'tickUpper__volumeUSD', 'token0', 'token0__decimals', 'token0__derivedETH', 'token0__feesUSD', 'token0__id', 'token0__name', 'token0__poolCount', 'token0__symbol', 'token0__totalSupply', 'token0__totalValueLocked', 'token0__totalValueLockedUSD', 'token0__totalValueLockedUSDUntracked', 'token0__txCount', 'token0__untrackedVolumeUSD', 'token0__volume', 'token0__volumeUSD', 'token1', 'token1__decimals', 'token1__derivedETH', 'token1__feesUSD', 'token1__id', 'token1__name', 'token1__poolCount', 'token1__symbol', 'token1__totalSupply', 'token1__totalValueLocked', 'token1__totalValueLockedUSD', 'token1__totalValueLockedUSDUntracked', 'token1__txCount', 'token1__untrackedVolumeUSD', 'token1__volume', 'token1__volumeUSD', 'transaction', 'transaction__blockNumber', 'transaction__gasPrice', 'transaction__gasUsed', 'transaction__id', 'transaction__timestamp', 'withdrawnToken0', 'withdrawnToken1')
...
class Swap_orderBy(sgqlc.types.Enum):
    __schema__ = graphql_schema
    __choices__ = ('amount0', 'amount1', 'amountUSD', 'id', 'logIndex', 'origin', 'pool', 'pool__collectedFeesToken0', 'pool__collectedFeesToken1', 'pool__collectedFeesUSD', 'pool__createdAtBlockNumber', 'pool__createdAtTimestamp', 'pool__feeGrowthGlobal0X128', 'pool__feeGrowthGlobal1X128', 'pool__feeTier', 'pool__feesUSD', 'pool__id', 'pool__liquidity', 'pool__liquidityProviderCount', 'pool__observationIndex', 'pool__sqrtPrice', 'pool__tick', 'pool__token0Price', 'pool__token1Price', 'pool__totalValueLockedETH', 'pool__totalValueLockedToken0', 'pool__totalValueLockedToken1', 'pool__totalValueLockedUSD', 'pool__totalValueLockedUSDUntracked', 'pool__txCount', 'pool__untrackedVolumeUSD', 'pool__volumeToken0', 'pool__volumeToken1', 'pool__volumeUSD', 'recipient', 'sender', 'sqrtPriceX96', 'tick', 'timestamp', 'token0', 'token0__decimals', 'token0__derivedETH', 'token0__feesUSD', 'token0__id', 'token0__name', 'token0__poolCount', 'token0__symbol', 'token0__totalSupply', 'token0__totalValueLocked', 'token0__totalValueLockedUSD', 'token0__totalValueLockedUSDUntracked', 'token0__txCount', 'token0__untrackedVolumeUSD', 'token0__volume', 'token0__volumeUSD', 'token1', 'token1__decimals', 'token1__derivedETH', 'token1__feesUSD', 'token1__id', 'token1__name', 'token1__poolCount', 'token1__symbol', 'token1__totalSupply', 'token1__totalValueLocked', 'token1__totalValueLockedUSD', 'token1__totalValueLockedUSDUntracked', 'token1__txCount', 'token1__untrackedVolumeUSD', 'token1__volume', 'token1__volumeUSD', 'transaction', 'transaction__blockNumber', 'transaction__gasPrice', 'transaction__gasUsed', 'transaction__id', 'transaction__timestamp')


class TickDayData_orderBy(sgqlc.types.Enum):
    __schema__ = graphql_schema
    __choices__ = ('date', 'feeGrowthOutside0X128', 'feeGrowthOutside1X128', 'feesUSD', 'id', 'liquidityGross', 'liquidityNet', 'pool', 'pool__collectedFeesToken0', 'pool__collectedFeesToken1', 'pool__collectedFeesUSD', 'pool__createdAtBlockNumber', 'pool__createdAtTimestamp', 'pool__feeGrowthGlobal0X128', 'pool__feeGrowthGlobal1X128', 'pool__feeTier', 'pool__feesUSD', 'pool__id', 'pool__liquidity', 'pool__liquidityProviderCount', 'pool__observationIndex', 'pool__sqrtPrice', 'pool__tick', 'pool__token0Price', 'pool__token1Price', 'pool__totalValueLockedETH', 'pool__totalValueLockedToken0', 'pool__totalValueLockedToken1', 'pool__totalValueLockedUSD', 'pool__totalValueLockedUSDUntracked', 'pool__txCount', 'pool__untrackedVolumeUSD', 'pool__volumeToken0', 'pool__volumeToken1', 'pool__volumeUSD', 'tick', 'tick__collectedFeesToken0', 'tick__collectedFeesToken1', 'tick__collectedFeesUSD', 'tick__createdAtBlockNumber', 'tick__createdAtTimestamp', 'tick__feeGrowthOutside0X128', 'tick__feeGrowthOutside1X128', 'tick__feesUSD', 'tick__id', 'tick__liquidityGross', 'tick__liquidityNet', 'tick__liquidityProviderCount', 'tick__poolAddress', 'tick__price0', 'tick__price1', 'tick__tickIdx', 'tick__untrackedVolumeUSD', 'tick__volumeToken0', 'tick__volumeToken1', 'tick__volumeUSD', 'volumeToken0', 'volumeToken1', 'volumeUSD')


class TickHourData_orderBy(sgqlc.types.Enum):
    __schema__ = graphql_schema
    __choices__ = ('feesUSD', 'id', 'liquidityGross', 'liquidityNet', 'periodStartUnix', 'pool', 'pool__collectedFeesToken0', 'pool__collectedFeesToken1', 'pool__collectedFeesUSD', 'pool__createdAtBlockNumber', 'pool__createdAtTimestamp', 'pool__feeGrowthGlobal0X128', 'pool__feeGrowthGlobal1X128', 'pool__feeTier', 'pool__feesUSD', 'pool__id', 'pool__liquidity', 'pool__liquidityProviderCount', 'pool__observationIndex', 'pool__sqrtPrice', 'pool__tick', 'pool__token0Price', 'pool__token1Price', 'pool__totalValueLockedETH', 'pool__totalValueLockedToken0', 'pool__totalValueLockedToken1', 'pool__totalValueLockedUSD', 'pool__totalValueLockedUSDUntracked', 'pool__txCount', 'pool__untrackedVolumeUSD', 'pool__volumeToken0', 'pool__volumeToken1', 'pool__volumeUSD', 'tick', 'tick__collectedFeesToken0', 'tick__collectedFeesToken1', 'tick__collectedFeesUSD', 'tick__createdAtBlockNumber', 'tick__createdAtTimestamp', 'tick__feeGrowthOutside0X128', 'tick__feeGrowthOutside1X128', 'tick__feesUSD', 'tick__id', 'tick__liquidityGross', 'tick__liquidityNet', 'tick__liquidityProviderCount', 'tick__poolAddress', 'tick__price0', 'tick__price1', 'tick__tickIdx', 'tick__untrackedVolumeUSD', 'tick__volumeToken0', 'tick__volumeToken1', 'tick__volumeUSD', 'volumeToken0', 'volumeToken1', 'volumeUSD')


class Tick_orderBy(sgqlc.types.Enum):
    __schema__ = graphql_schema
    __choices__ = ('collectedFeesToken0', 'collectedFeesToken1', 'collectedFeesUSD', 'createdAtBlockNumber', 'createdAtTimestamp', 'feeGrowthOutside0X128', 'feeGrowthOutside1X128', 'feesUSD', 'id', 'liquidityGross', 'liquidityNet', 'liquidityProviderCount', 'pool', 'poolAddress', 'pool__collectedFeesToken0', 'pool__collectedFeesToken1', 'pool__collectedFeesUSD', 'pool__createdAtBlockNumber', 'pool__createdAtTimestamp', 'pool__feeGrowthGlobal0X128', 'pool__feeGrowthGlobal1X128', 'pool__feeTier', 'pool__feesUSD', 'pool__id', 'pool__liquidity', 'pool__liquidityProviderCount', 'pool__observationIndex', 'pool__sqrtPrice', 'pool__tick', 'pool__token0Price', 'pool__token1Price', 'pool__totalValueLockedETH', 'pool__totalValueLockedToken0', 'pool__totalValueLockedToken1', 'pool__totalValueLockedUSD', 'pool__totalValueLockedUSDUntracked', 'pool__txCount', 'pool__untrackedVolumeUSD', 'pool__volumeToken0', 'pool__volumeToken1', 'pool__volumeUSD', 'price0', 'price1', 'tickIdx', 'untrackedVolumeUSD', 'volumeToken0', 'volumeToken1', 'volumeUSD')
...
class Collect_filter(sgqlc.types.Input):
    ...
    log_index_not_in = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(BigInt)), graphql_name='logIndex_not_in')
    _change_block = sgqlc.types.Field(BlockChangedFilter, graphql_name='_change_block')
    and_ = sgqlc.types.Field(sgqlc.types.list_of('Collect_filter'), graphql_name='and')
    or_ = sgqlc.types.Field(sgqlc.types.list_of('Collect_filter'), graphql_name='or')
...
class Flash_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'transaction', 'transaction_not', 'transaction_gt', 'transaction_lt', 'transaction_gte', 'transaction_lte', 'transaction_in', 'transaction_not_in', 'transaction_contains', 'transaction_contains_nocase', 'transaction_not_contains', 'transaction_not_contains_nocase', 'transaction_starts_with', 'transaction_starts_with_nocase', 'transaction_not_starts_with', 'transaction_not_starts_with_nocase', 'transaction_ends_with', 'transaction_ends_with_nocase', 'transaction_not_ends_with', 'transaction_not_ends_with_nocase', 'transaction_', 'timestamp', 'timestamp_not', 'timestamp_gt', 'timestamp_lt', 'timestamp_gte', 'timestamp_lte', 'timestamp_in', 'timestamp_not_in', 'pool', 'pool_not', 'pool_gt', 'pool_lt', 'pool_gte', 'pool_lte', 'pool_in', 'pool_not_in', 'pool_contains', 'pool_contains_nocase', 'pool_not_contains', 'pool_not_contains_nocase', 'pool_starts_with', 'pool_starts_with_nocase', 'pool_not_starts_with', 'pool_not_starts_with_nocase', 'pool_ends_with', 'pool_ends_with_nocase', 'pool_not_ends_with', 'pool_not_ends_with_nocase', 'pool_', 'sender', 'sender_not', 'sender_gt', 'sender_lt', 'sender_gte', 'sender_lte', 'sender_in', 'sender_not_in', 'sender_contains', 'sender_not_contains', 'recipient', 'recipient_not', 'recipient_gt', 'recipient_lt', 'recipient_gte', 'recipient_lte', 'recipient_in', 'recipient_not_in', 'recipient_contains', 'recipient_not_contains', 'amount0', 'amount0_not', 'amount0_gt', 'amount0_lt', 'amount0_gte', 'amount0_lte', 'amount0_in', 'amount0_not_in', 'amount1', 'amount1_not', 'amount1_gt', 'amount1_lt', 'amount1_gte', 'amount1_lte', 'amount1_in', 'amount1_not_in', 'amount_usd', 'amount_usd_not', 'amount_usd_gt', 'amount_usd_lt', 'amount_usd_gte', 'amount_usd_lte', 'amount_usd_in', 'amount_usd_not_in', 'amount0_paid', 'amount0_paid_not', 'amount0_paid_gt', 'amount0_paid_lt', 'amount0_paid_gte', 'amount0_paid_lte', 'amount0_paid_in', 'amount0_paid_not_in', 'amount1_paid', 'amount1_paid_not', 'amount1_paid_gt', 'amount1_paid_lt', 'amount1_paid_gte', 'amount1_paid_lte', 'amount1_paid_in', 'amount1_paid_not_in', 'log_index', 'log_index_not', 'log_index_gt', 'log_index_lt', 'log_index_gte', 'log_index_lte', 'log_index_in', 'log_index_not_in', '_change_block', 'and_', 'or_')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
    ...
    recipient_gt = sgqlc.types.Field(Bytes, graphql_name='recipient_gt')
    recipient_lt = sgqlc.types.Field(Bytes, graphql_name='recipient_lt')
    recipient_gte = sgqlc.types.Field(Bytes, graphql_name='recipient_gte')
    recipient_lte = sgqlc.types.Field(Bytes, graphql_name='recipient_lte')
    ...
    log_index_not_in = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(BigInt)), graphql_name='logIndex_not_in')
    _change_block = sgqlc.types.Field(BlockChangedFilter, graphql_name='_change_block')
    and_ = sgqlc.types.Field(sgqlc.types.list_of('Flash_filter'), graphql_name='and')
    or_ = sgqlc.types.Field(sgqlc.types.list_of('Flash_filter'), graphql_name='or')


class Mint_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'transaction', 'transaction_not', 'transaction_gt', 'transaction_lt', 'transaction_gte', 'transaction_lte', 'transaction_in', 'transaction_not_in', 'transaction_contains', 'transaction_contains_nocase', 'transaction_not_contains', 'transaction_not_contains_nocase', 'transaction_starts_with', 'transaction_starts_with_nocase', 'transaction_not_starts_with', 'transaction_not_starts_with_nocase', 'transaction_ends_with', 'transaction_ends_with_nocase', 'transaction_not_ends_with', 'transaction_not_ends_with_nocase', 'transaction_', 'timestamp', 'timestamp_not', 'timestamp_gt', 'timestamp_lt', 'timestamp_gte', 'timestamp_lte', 'timestamp_in', 'timestamp_not_in', 'pool', 'pool_not', 'pool_gt', 'pool_lt', 'pool_gte', 'pool_lte', 'pool_in', 'pool_not_in', 'pool_contains', 'pool_contains_nocase', 'pool_not_contains', 'pool_not_contains_nocase', 'pool_starts_with', 'pool_starts_with_nocase', 'pool_not_starts_with', 'pool_not_starts_with_nocase', 'pool_ends_with', 'pool_ends_with_nocase', 'pool_not_ends_with', 'pool_not_ends_with_nocase', 'pool_', 'token0', 'token0_not', 'token0_gt', 'token0_lt', 'token0_gte', 'token0_lte', 'token0_in', 'token0_not_in', 'token0_contains', 'token0_contains_nocase', 'token0_not_contains', 'token0_not_contains_nocase', 'token0_starts_with', 'token0_starts_with_nocase', 'token0_not_starts_with', 'token0_not_starts_with_nocase', 'token0_ends_with', 'token0_ends_with_nocase', 'token0_not_ends_with', 'token0_not_ends_with_nocase', 'token0_', 'token1', 'token1_not', 'token1_gt', 'token1_lt', 'token1_gte', 'token1_lte', 'token1_in', 'token1_not_in', 'token1_contains', 'token1_contains_nocase', 'token1_not_contains', 'token1_not_contains_nocase', 'token1_starts_with', 'token1_starts_with_nocase', 'token1_not_starts_with', 'token1_not_starts_with_nocase', 'token1_ends_with', 'token1_ends_with_nocase', 'token1_not_ends_with', 'token1_not_ends_with_nocase', 'token1_', 'owner', 'owner_not', 'owner_gt', 'owner_lt', 'owner_gte', 'owner_lte', 'owner_in', 'owner_not_in', 'owner_contains', 'owner_not_contains', 'sender', 'sender_not', 'sender_gt', 'sender_lt', 'sender_gte', 'sender_lte', 'sender_in', 'sender_not_in', 'sender_contains', 'sender_not_contains', 'origin', 'origin_not', 'origin_gt', 'origin_lt', 'origin_gte', 'origin_lte', 'origin_in', 'origin_not_in', 'origin_contains', 'origin_not_contains', 'amount', 'amount_not', 'amount_gt', 'amount_lt', 'amount_gte', 'amount_lte', 'amount_in', 'amount_not_in', 'amount0', 'amount0_not', 'amount0_gt', 'amount0_lt', 'amount0_gte', 'amount0_lte', 'amount0_in', 'amount0_not_in', 'amount1', 'amount1_not', 'amount1_gt', 'amount1_lt', 'amount1_gte', 'amount1_lte', 'amount1_in', 'amount1_not_in', 'amount_usd', 'amount_usd_not', 'amount_usd_gt', 'amount_usd_lt', 'amount_usd_gte', 'amount_usd_lte', 'amount_usd_in', 'amount_usd_not_in', 'tick_lower', 'tick_lower_not', 'tick_lower_gt', 'tick_lower_lt', 'tick_lower_gte', 'tick_lower_lte', 'tick_lower_in', 'tick_lower_not_in', 'tick_upper', 'tick_upper_not', 'tick_upper_gt', 'tick_upper_lt', 'tick_upper_gte', 'tick_upper_lte', 'tick_upper_in', 'tick_upper_not_in', 'log_index', 'log_index_not', 'log_index_gt', 'log_index_lt', 'log_index_gte', 'log_index_lte', 'log_index_in', 'log_index_not_in', '_change_block', 'and_', 'or_')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class PositionSnapshot_filter(sgqlc.types.Input):
    ...
    _change_block = sgqlc.types.Field(BlockChangedFilter, graphql_name='_change_block')
    and_ = sgqlc.types.Field(sgqlc.types.list_of('PositionSnapshot_filter'), graphql_name='and')
    or_ = sgqlc.types.Field(sgqlc.types.list_of('PositionSnapshot_filter'), graphql_name='or')
...
class TickDayData_filter(sgqlc.types.Input):
    ...
    _change_block = sgqlc.types.Field(BlockChangedFilter, graphql_name='_change_block')
    and_ = sgqlc.types.Field(sgqlc.types.list_of('TickDayData_filter'), graphql_name='and')
    or_ = sgqlc.types.Field(sgqlc.types.list_of('TickDayData_filter'), graphql_name='or')


class TickHourData_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'period_start_unix', 'period_start_unix_not', 'period_start_unix_gt', 'period_start_unix_lt', 'period_start_unix_gte', 'period_start_unix_lte', 'period_start_unix_in', 'period_start_unix_not_in', 'pool', 'pool_not', 'pool_gt', 'pool_lt', 'pool_gte', 'pool_lte', 'pool_in', 'pool_not_in', 'pool_contains', 'pool_contains_nocase', 'pool_not_contains', 'pool_not_contains_nocase', 'pool_starts_with', 'pool_starts_with_nocase', 'pool_not_starts_with', 'pool_not_starts_with_nocase', 'pool_ends_with', 'pool_ends_with_nocase', 'pool_not_ends_with', 'pool_not_ends_with_nocase', 'pool_', 'tick', 'tick_not', 'tick_gt', 'tick_lt', 'tick_gte', 'tick_lte', 'tick_in', 'tick_not_in', 'tick_contains', 'tick_contains_nocase', 'tick_not_contains', 'tick_not_contains_nocase', 'tick_starts_with', 'tick_starts_with_nocase', 'tick_not_starts_with', 'tick_not_starts_with_nocase', 'tick_ends_with', 'tick_ends_with_nocase', 'tick_not_ends_with', 'tick_not_ends_with_nocase', 'tick_', 'liquidity_gross', 'liquidity_gross_not', 'liquidity_gross_gt', 'liquidity_gross_lt', 'liquidity_gross_gte', 'liquidity_gross_lte', 'liquidity_gross_in', 'liquidity_gross_not_in', 'liquidity_net', 'liquidity_net_not', 'liquidity_net_gt', 'liquidity_net_lt', 'liquidity_net_gte', 'liquidity_net_lte', 'liquidity_net_in', 'liquidity_net_not_in', 'volume_token0', 'volume_token0_not', 'volume_token0_gt', 'volume_token0_lt', 'volume_token0_gte', 'volume_token0_lte', 'volume_token0_in', 'volume_token0_not_in', 'volume_token1', 'volume_token1_not', 'volume_token1_gt', 'volume_token1_lt', 'volume_token1_gte', 'volume_token1_lte', 'volume_token1_in', 'volume_token1_not_in', 'volume_usd', 'volume_usd_not', 'volume_usd_gt', 'volume_usd_lt', 'volume_usd_gte', 'volume_usd_lte', 'volume_usd_in', 'volume_usd_not_in', 'fees_usd', 'fees_usd_not', 'fees_usd_gt', 'fees_usd_lt', 'fees_usd_gte', 'fees_usd_lte', 'fees_usd_in', 'fees_usd_not_in', '_change_block', 'and_', 'or_')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
    ...
    fees_usd_not_in = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(BigDecimal)), graphql_name='feesUSD_not_in')
    _change_block = sgqlc.types.Field(BlockChangedFilter, graphql_name='_change_block')
    and_ = sgqlc.types.Field(sgqlc.types.list_of('TickHourData_filter'), graphql_name='and')
    or_ = sgqlc.types.Field(sgqlc.types.list_of('TickHourData_filter'), graphql_name='or')
...
class Transaction_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'block_number', 'block_number_not', 'block_number_gt', 'block_number_lt', 'block_number_gte', 'block_number_lte', 'block_number_in', 'block_number_not_in', 'timestamp', 'timestamp_not', 'timestamp_gt', 'timestamp_lt', 'timestamp_gte', 'timestamp_lte', 'timestamp_in', 'timestamp_not_in', 'gas_used', 'gas_used_not', 'gas_used_gt', 'gas_used_lt', 'gas_used_gte', 'gas_used_lte', 'gas_used_in', 'gas_used_not_in', 'gas_price', 'gas_price_not', 'gas_price_gt', 'gas_price_lt', 'gas_price_gte', 'gas_price_lte', 'gas_price_in', 'gas_price_not_in', 'mints_', 'burns_', 'swaps_', 'flashed_', 'collects_', '_change_block', 'and_', 'or_')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
